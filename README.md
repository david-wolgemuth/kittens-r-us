...
Create an "Are you still there?" modal using Create React App, with two Views.

View 1 will show a modal after 10 seconds. Inside the modal will be a button to click in order to stay on this view. If the user doesn't click this button after 5 seconds, the user will be shown View 2.

View 2 will have a button to return the user to View 1.

On View 1, if the user dismisses the modal, it should pop up again after 10 seconds.

The content of these 2 Views isn't important, only that they contain the components described.
